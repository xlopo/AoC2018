...
count = Counter([g[0] for g in guard_log])
guard_with_most_sleep = count.most_common(1)[0][0]

count = Counter([g[1] for g in guard_log if g[0] == guard_with_most_sleep])
most_slept_minute = count.most_common(1)[0][0]

print(guard_with_most_sleep * most_slept_minute)
